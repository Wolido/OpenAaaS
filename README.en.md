...
- **Aug 2026 — IDM-Alpha Materials Science Literature Research Assistant backend upgraded** (Service ID: `12cbaacc-80b4-4e8b-98a4-3b50ee9f903f`): significantly improved answer accuracy for materials science literature Q&A.
- **Aug 2026 — AFLOW Materials Database Query Agent launched on the public server** (Service ID: `923f5a90-ef12-4dba-bc86-5a121afb41af`): query the AFLOW materials database in natural language — no query syntax required. See the [Available Services](#available-services) table below.
...
| Name | ID | Description |
|---|---|---|
| AFLOW Materials Database Query Agent | `923f5a90-ef12-4dba-bc86-5a121afb41af` | Natural-language query executor for the AFLOW materials database. Translates materials research intent into validated, scope-limited AFLOW queries and returns a readable Markdown response plus structured result files; no AFLUX syntax required. Supports query execution and result comparison. |
